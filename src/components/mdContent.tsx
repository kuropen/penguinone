...
import { DetailedHTMLProps, HTMLAttributes } from 'react-intl/node_modules/@types/react'
...
const Root = styled('div')(({ theme }) => ({
  ...
  '& blockquote': {
    ...
    backgroundColor:
      theme.palette.mode === 'dark'
        ? // Support Material design theme
          alpha(theme.palette.warning.dark, 0.09)
...
const MDContent = React.forwardRef<HTMLDivElement>((props: DetailedHTMLProps<HTMLAttributes<HTMLDivElement>, HTMLDivElement>, ref) => {
    return (
        <Root {...props} ref={ref} />
    )
})
